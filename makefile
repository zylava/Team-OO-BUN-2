...
test: ngnix/config_parser.cc response.cpp request.cpp request_handler.cpp request_handler_echo.cpp request_handler_static.cpp \
	request_handler_default.cpp request_handler_default_test.cpp server.cpp server_test.cpp connection.cpp
	g++ ngnix/config_parser.cc response.cpp request.cpp request_handler.cpp request_handler_echo.cpp request_handler_static.cpp \
	request_handler_default.cpp request_handler_default_test.cpp server.cpp server_test.cpp connection.cpp \
	...
	./mytest
	gcov -r server.cpp request_handler_default.cpp
