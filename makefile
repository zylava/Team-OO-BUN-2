...
test: ngnix/config_parser.cc server_monitor.cpp response.cpp response_test.cpp request.cpp request_test.cpp request_handler.cpp request_handler_echo.cpp request_handler_static.cpp request_handler_static_test.cpp \
	request_handler_default.cpp request_handler_default_test.cpp request_handler_status.cpp request_handler_status_test.cpp server.cpp server_test.cpp connection.cpp ${GTEST_DIR}/src/gtest-all.cc ${GTEST_DIR}/src/gtest_main.cc ${GMOCK_DIR}/src/gmock-all.cc
	...
	request_handler_default.cpp request_handler_default_test.cpp request_handler_status.cpp request_handler_status_test.cpp server.cpp server_test.cpp connection.cpp -isystem ${GTEST_DIR}/include -I${GTEST_DIR} ${GTEST_DIR}/src/gtest-all.cc ${GTEST_DIR}/src/gtest_main.cc \
	...
	./mytest
	gcov -r server.cpp connection.cpp request.cpp response.cpp request_handler_status.cpp request_handler_default_test.cpp request_handler_static.cpp server_monitor.cpp
